        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="col-md-9">
                    <table class="active">
                        <tbody>
                            <tr v-for="row in board" :key="row">
                                <td v-on:click="cellClick(cell);" :key="cell.x + '-' + cell.y" v-on:contextmenu.prevent="cellRightClick(cell);" style="background-color: white;" v-bind:class="computeStyle(cell)" v-for="cell in row" v-bind:data-index="cell.x + '-' + cell.y">
                                    {{ compute(cell) }}
                                </td>
                            </tr>
                        </tbody>
